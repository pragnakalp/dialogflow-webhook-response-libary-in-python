...
# description        : This library is used to prepare custom payload for Facebook Messenger generic template
#                      with elements like image, title, subtitle, URL button and postback button.
#                      It will automatically create carousel if more than 1 generic templates are passed.
